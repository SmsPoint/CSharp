...
${nuget_cmd} install src/Com.Nvt.Celman/packages.config -o packages;
...
echo "[INFO] Run 'mcs' to build bin/Com.Nvt.Celman.dll"
mcs -langversion:${langversion} -sdk:${sdk} -r:bin/Newtonsoft.Json.dll,bin/JsonSubTypes.dll,\
bin/RestSharp.dll,\
System.ComponentModel.DataAnnotations.dll,\
System.Runtime.Serialization.dll \
-target:library \
-out:bin/Com.Nvt.Celman.dll \
-recurse:'src/Com.Nvt.Celman/*.cs' \
-doc:bin/Com.Nvt.Celman.xml \
-platform:anycpu
...
then
  ...
  echo "[INFO] bin/Com.Nvt.Celman.dll was created successfully"
fi
